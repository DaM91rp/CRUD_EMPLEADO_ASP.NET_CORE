...
using CRUDCOREEF.Models;
using CRUDCOREEF.Models.ViewModels;
using Microsoft.AspNetCore.Mvc;
using System.Diagnostics;

namespace CRUDCOREEF.Controllers
{
    public class HomeController : Controller
    {
        private readonly DBCRUDCOREEFContext _DBContext;

        public HomeController(DBCRUDCOREEFContext context)
        {
            _DBContext = context;
        }
